<template>
  <div class="sayfa bg-black">
    <div class="q-pa-md bg-white" style="max-width: 1260px;">

      <div class="row bg-white justify-center">
        <div class="line col-4"></div>
        <div class="bg-white col-3 q-px-md justify-center"><div class="title q-ma-md text-white ">Yeni Üyelik</div></div>
        <div class="line col-4"></div>
      </div>
      ...
      <q-card-section>
        <form @submit.prevent="submitForm">
          ...
          <q-card-section class="column" style="margin-left: 30%;">
            <q-checkbox
              checked-icon="square"
              color="pink"
          ...
          <q-card-actions align="right" style="margin-right: 30%;">
            <q-btn label="İptal" text-color="grey" style="background-color: #eee;" @click="cancelForm" />
            <q-btn type="submit" label="Kaydet" label-color="white" style="background-color: #f9ec11;" />
          </q-card-actions>
